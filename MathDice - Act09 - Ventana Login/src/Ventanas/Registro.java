...
//CONSTRUCTOR**************************************************************************************************CONSTRUCTOR
	...
	public Registro(conexionBBDD bbdd) {
		...
		//Recibimos la conexión a la BBDD desde el Login a través del Constructor
		this.bbdd = bbdd;
		
			//Comprobamos la conexión de la BBDD con el método connectDB de conexionBBDD.java
			if(bbdd.connectDB()==true){
				error = "Bienvenido/a";
				System.out.println("Registro: Conectado con éxito a la BBDD");
			}else{
				error = "Error en la conexión con la BBDD, si continua sus datos no se registrarán";
				System.out.println("Registro: Error en la conexión con la BBDD");
			}
		
		//Objeto usuarioBBDD
		//Pillamos la conexión de la BBDD y se la enviamos a el usuarioBBDD para que pueda utilizarla
